...
#===============================================================================
#
#         FILE: check_oracle_archive_log.pl
#
#        USAGE: ./check_oracle_archive_log.pl  
#
...
my $ParseOptions = 'OracleArchiveLog::ParseOptions';
load $ParseOptions;
...
if ( $Options{'LOG_MODE'}{'LOG_MODE'} eq 'ARCHIVELOG' ) {
    # defaults
...
print "$Options{'nagios-msg'} - $Options{'LOG_MODE'}{'LOG_MODE'}" . "\n";
