...
my $ParseOptions = 'OracleStatus::ParseOptions';
load $ParseOptions;
...
if ( $Options{'ORACLE_STATUS'}{'STATUS'} eq 'OPEN' ) {
...
print "$Options{'nagios-msg'} - $Options{'ORACLE_STATUS'}{'STATUS'}" . "\n";
