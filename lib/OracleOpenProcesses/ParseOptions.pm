package OracleOpenProcesses::ParseOptions;
...
#      PACKAGE: OracleOpenProcesses::ParseOptions
#
#  DESCRIPTION: ParseOptions for OracleOpenProcesses
#
#        FILES: ---
#         BUGS: ---
#        NOTES: ---
...
sub parse {
    ...
    if ($Options{'percent'}) { $Options{'P'} = $Options{'percent'} };
    if ($Options{'P'}) { $Options{'percent'} = $Options{'P'} };
...
OracleOpenProcesses::ParseOptions - ParseOptions for OracleOpenProcesses 

=head1 SYNOPSIS

use OracleOpenProcesses::ParseOptions;

my $object = OracleOpenProcesses::ParseOptions->new();
